...
const File = () => {
    ...
    useEffect(()=>{
       ...
       const material=new THREE.ShaderMaterial({
        ...
        pos+=normalize(pos-uMouse)*smoothstep(1.0,0.0,d)*0.3;
       ...
       function createparticles(){
        ...
        const mouse=new THREE.Vector3(mousex,mousey,0.0);
        ...
        function animate(){
            ...
            if(intersect.length>0){
                ...
                const dy=position[i*3+1]-point.y;
                const dz=position[i*3+2]-point.z;
